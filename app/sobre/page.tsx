      ...
      <section className="mt-20">
        <div className="mb-10 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-zinc-400">
            ...
            <strong className="font-semibold text-zinc-300">Next.js</strong>,{" "}
            <strong className="font-semibold text-zinc-300">Supabase</strong> e{" "}
        ...
        <div className="grid gap-5 md:grid-cols-3">
          {stack.map((item) => {
            ...
            return (
              <Card
                key={item.name}
                className="flex flex-col border-white/10 bg-gradient-to-br from-renthus-purple-light/[0.1] via-renthus-purple-dark/[0.55] to-[#07030c] p-0 ring-1 ring-renthus-orange/10"
              >
                <CardHeader>
                  <div className="mb-3 flex h-11 w-11 items-center justify-center rounded-lg border border-white/10 bg-white/[0.05]">
